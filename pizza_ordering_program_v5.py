...
enter you delivery address if you pick delivery
You can type shortcuts for everything or type the whole word if 
you are not lazy
Example:
d = delivery
p = pickup
...
Type x in the ordering section to finish your order and continue the cart.
''')
